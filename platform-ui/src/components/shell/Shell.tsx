...
export function Shell({ me, tenantId, moduleLabel, prefs = DEFAULT_PREFS, placement = null, children }: {
  me: Me; tenantId: string | null; moduleLabel: string; prefs?: Prefs; placement?: MyPlacement | null; children: ReactNode;
}) {
  const special = canViewAllCompanies(me);
  return (
    <div className="erp-app" data-density={prefs.density} data-width={prefs.width}>
      <a href="#main-content" className="skip-link">Skip to content</a>
      <Sidebar me={me} tenantId={tenantId} placement={placement} />
