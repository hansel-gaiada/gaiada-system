...
// HR › People — the company people directory. Rows open the employee 360 at
// /people/[userId] (kept where it is). Access limited to owners/admins.
    ...
    <>
      {canInvite && (
        <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 16 }}>
          <Link href="/people/new" className="lux-btn lux-btn--solid lux-btn--sm">Invite employee</Link>
        </div>
      )}
      {people.length === 0 ? (
