...
export default async function AppraisalsSectionLayout({ children }: { children: React.ReactNode }) {
  if (!(await isModuleOnForActiveCompany("reports"))) return <ModuleDisabled module="reports" label="Appraisals" />;
  return <>{children}</>;
}
