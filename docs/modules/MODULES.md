...
**0.5.28 (2026-08-23, senior-be, SMM-35 closing pass) — one social write reachable from `/assistant`,
...
remaining gap. Full detail: `docs/modules/CHANGELOG.md`'s `0.5.28` entry.
