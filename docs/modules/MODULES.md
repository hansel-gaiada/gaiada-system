...
**`Alpha 01.067.0144a`** â€” see [`VERSIONING.md`](./VERSIONING.md) for the format, and
...
|---|---|---|---|---|
| platform-nest | `0.40.1` | IN PROGRESS | WS1 | 2026-08-26 |
| platform-ui | `0.58.0` | IN PROGRESS | WS5 | 2026-08-26 |
...
| finance | `0.15.0` | PROTOTYPED | Finance & Accounting | 2026-08-27 |
