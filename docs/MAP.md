...
- Head: `0113_social_inbox_retention.sql`
- Next free number: `0114` — **reserve it by creating the file**, concurrent sessions share this checkout.
- Applied files on disk: 112
