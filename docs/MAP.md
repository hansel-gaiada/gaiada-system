...
- Head: `0116_social_variant_uploaded_media.sql`
- Next free number: `0117` — **reserve it by creating the file**, concurrent sessions share this checkout.
- Applied files on disk: 116
