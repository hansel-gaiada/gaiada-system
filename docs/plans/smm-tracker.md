...
| P2 inbox + client approval | 0 (+1 partial) | 6 |
...
| # | Ticket | State | Gate |
|---|---|---|---|
| SMM-31 | Client review backend: `social_post_client_reviews` state machine, portal decide, `portal.approve_post`, idempotent decision | 🟡 **partial** | backend DEV-VERIFIED this pass (318/318, 0 skipped); **missing:** merge to `main` and SMM-32's UI — see evidence below |
