...
//   - `REAL_ROLES`: the 21 real, nameable Cerbos roles, as a readonly tuple so importers get
...
//     (20 -> 21) — keep this tuple in lockstep with the .mjs's own REAL_ROLES array; a mismatch
//     here is a TS error at every importer, not a silent drift, which is the point of hand-writing
//     it rather than inferring `string[]`.
