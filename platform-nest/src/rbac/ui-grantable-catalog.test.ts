...
describe("IAM Phase 2 (P2-03) · ui_grantable allow-list — catalog completeness + pinned invariants", () => {
  ...
  it("sanity: the catalog has grown to 320 pairs (305 grantable + 15 relationship) — HR-FULL (2026-08-24): +18 grantable across 3 new HR kinds [hr_policy/hr_recruitment/hr_payroll], role-arm only; FINANCE-F0 (2026-08-24): +13 grantable across 3 new finance kinds [finance_config/finance_period/finance_control], role-arm only, 320 -> 333; FINANCE-F1 (2026-08-24): +4 grantable on 1 new kind [finance_ledger], 345 -> 349; WSK-12 (2026-08-27): +2 on 1 new kind [webdev_zoneb_event], 378 -> 380 pairs / 363 -> 365 grantable", () => {
    ...
    expect(permissions.length).toBe(381);
    expect(permissions.filter((p) => p.class === "grantable").length).toBe(366);
