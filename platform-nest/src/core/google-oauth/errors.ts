...
// WD-23A-1: moved from modules/search/google/errors.ts. These are the OAuth-GENERIC failures every
// Google surface can raise; the three search-specific subclasses (property-not-bound, Ads customer,
// Ads config) stayed behind in search and extend GoogleSurfaceError from here.
